...
use Brunopignatari\LaravelBoleto\Cnab\Retorno\Cnab400\Banco\Bradesco;
...
class RetornoCnab400Test extends TestCase
{
    ...
    {
        $retorno = \Brunopignatari\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/banco_brasil.ret');
        $retorno->processar();
    ...
    {
        $retorno = \Brunopignatari\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/itau.ret');
        $retorno->processar();
    ...
    {
        $retorno = \Brunopignatari\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/cef.ret');
        $retorno->processar();
    ...
    {
        $retorno = \Brunopignatari\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/hsbc.ret');
        $retorno->processar();
    ...
    {
        $retorno = \Brunopignatari\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/santander.ret');
        $retorno->processar();
    ...
    {
        $retorno = \Brunopignatari\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/sicredi.ret');
        $retorno->processar();
