...
.. code-block:: php
    ...
    // for 400 positions
    $send = new Brunopignatari\LaravelBoleto\Cnab\Remessa\Cnab400\Banco\Banrisul;

    // Or, for 240 positions
    $send = new Brunopignatari\LaravelBoleto\Cnab\Remessa\Cnab240\Banco\Banrisul;
...
.. code-block:: php
    ...
    // for 400 positions
    $send = new Brunopignatari\LaravelBoleto\Cnab\Remessa\Cnab400\Banco\Banrisul($sendArray);

    // Or, for 240 positions
    $send = new Brunopignatari\LaravelBoleto\Cnab\Remessa\Cnab240\Banco\Banrisul($sendArray);
