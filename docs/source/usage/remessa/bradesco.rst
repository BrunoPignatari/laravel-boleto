...
.. code-block:: php
    ...
    // for 400 positions
    $send = new Brunopignatari\LaravelBoleto\Cnab\Remessa\Cnab400\Banco\Bradesco;

    // Or, for 240 positions
    $send = new Brunopignatari\LaravelBoleto\Cnab\Remessa\Cnab240\Banco\Bradesco;
...
.. code-block:: php
    ...
    // for 400 positions
    $send = new Brunopignatari\LaravelBoleto\Cnab\Remessa\Cnab400\Banco\Bradesco($sendArray);

    // Or, for 240 positions
    $send = new Brunopignatari\LaravelBoleto\Cnab\Remessa\Cnab240\Banco\Bradesco($sendArray);
